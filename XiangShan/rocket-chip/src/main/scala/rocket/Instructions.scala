...
object Instructions {
  //mlabaf//capstone main instruction
  def CLD                = BitPat("b?????????????????011?????1011011")//mlabaf//capstone
  def CSD                = BitPat("b?????????????????100?????1011011")
  def CREVOKE            = BitPat("b0000000??????????001?????1011011")
  def CSHRINK            = BitPat("b0000001??????????001?????1011011")
  def CTIGHTEN           = BitPat("b0000010??????????001?????1011011")
  def CDELIN             = BitPat("b0000011??????????001?????1011011")
  def CLCC               = BitPat("b0000100??????????001?????1011011")
  def CSCC               = BitPat("b0000101??????????001?????1011011")
  def CSPLIT             = BitPat("b0000110??????????001?????1011011")
  def CSEAL              = BitPat("b0000111??????????001?????1011011")
  def CMREV              = BitPat("b0001000??????????001?????1011011")
  def CINIT              = BitPat("b0001001??????????001?????1011011")
  def CMOVC              = BitPat("b0001010??????????001?????1011011")
  def CDROP              = BitPat("b0001011??????????001?????1011011")
  def CCINCOFFSET        = BitPat("b0001100??????????001?????1011011")
  def CCALL              = BitPat("b0100000??????????001?????1011011")
  def CRETURN            = BitPat("b0100001??????????001?????1011011")
  def CJALR              = BitPat("b?????????????????101?????1011011")
  def CCBNZ              = BitPat("b?????????????????110?????1011011")
  def CCCSRRW            = BitPat("b?????????????????111?????1011011")
  def CCAPENTER          = BitPat("b0001101??????????001?????1011011")
  def CCINCOFFSETIM      = BitPat("b?????????????????010?????1011011")
  def CSHRINKTO          = BitPat("b?????????????????000?????1011011")

  //mlabaf//capstone test instruction
  def CCREATE          = BitPat("b?????????????????011?????1111011")//mlabaf//capstone
  def CTYPE            = BitPat("b?????????????????010?????1111011")
  def CNODE            = BitPat("b1001000??????????001?????1111011")
  def CPERM            = BitPat("b1000001??????????001?????1111011")
  def CBOUND           = BitPat("b1000010??????????001?????1111011")
  def CPRINT           = BitPat("b1000011??????????001?????1111011")
  def CREGPRINT        = BitPat("b1000100??????????001?????1111011")
  def GETRAND          = BitPat("b1000101??????????001?????1111011")
  def TAGSET           = BitPat("b1000110??????????001?????1111011")
  def TAGGET           = BitPat("b1000111??????????001?????1111011")
 // def SDD              = BitPat("b0001010??????????001?????1110011")
